...
namespace BridgeUI.Common
{
    ...
    public class GraphPanel : BridgeUI.SinglePanel
    {
        ...
        private string path;
        private GraphNodeBehaiver rootItem;
        ...
        private GraphNodeBehaiver GetInstenceItem(int deepth, Transform parent)
        {
            if (deepth < 7)
            {
        ...
        private void SaveComplic(GraphNodeBehaiver nodeBehaiver, SelectorData parent)
        {
            //保存信息
