...
{
    public class InfoSpriteShow : MonoBehaviour, IPointerEnterHandler
    {
        ...
        public void OnPointerEnter(PointerEventData eventData)
        {
            ...
            sender["sprite"] = spriteshow;

            if (specialColor) sender["fontColor"] = fontColor;
            if (specialSize) sender["fontSize"] = fontSize;
            UIFacade.Instence.Open(typeof(SpriteInfoBehaiver).Name, sender);
        }
        public void OnPointerExit(PointerEventData eventData)
        {
            UIFacade.Instence.Close(typeof(SpriteInfoBehaiver).Name);
        }
    }
}