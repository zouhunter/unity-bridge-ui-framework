...
namespace BridgeUI.Control.Infinate
{
    ...
    public delegate void CellViewVisibilityChangedDelegate(ScrollViewItem cellView);

    /// <summary>
    /// This delegate will be fired just before the cell view is recycled
    /// </summary>
    /// <param name="cellView"></param>
    public delegate void CellViewWillRecycleDelegate(ScrollViewItem cellView);
    ...
    public delegate void ScrollerScrolledDelegate(InfinateScroll scroller, Vector2 val, float scrollPosition);
    ...
    public delegate void ScrollerSnappedDelegate(InfinateScroll scroller, int cellIndex, int dataIndex);
    ...
    public delegate void ScrollerScrollingChangedDelegate(InfinateScroll scroller, bool scrolling);
    ...
    public delegate void ScrollerTweeningChangedDelegate(InfinateScroll scroller, bool tweening);
    ...
    /// </summary>
    public class InfinateScroll : MonoBehaviour
    {
        #region Public
        ...
        /// </summary>
        public IInfinateScrollDelegate Delegate { get { return _delegate; } set { _delegate = value; _reloadData = true; } }
        ...
        /// <returns></returns>
        public ScrollViewItem GetCellView(ScrollViewItem cellPrefab)
        {
            ...
            if (cellView == null)
            {
                ...
                cellView = go.GetComponent<ScrollViewItem>();
        ...
        /// </summary>
        private IInfinateScrollDelegate _delegate;
        ...
        /// </summary>
        private SmallList<ScrollViewItem> _recycledCellViews = new SmallList<ScrollViewItem>();
        ...
        /// </summary>
        private SmallList<ScrollViewItem> _activeCellViews = new SmallList<ScrollViewItem>();
        ...
        /// <returns></returns>
        private ScrollViewItem _GetRecycledCellView(ScrollViewItem cellPrefab)
        {
            for (var i = 0; i < _recycledCellViews.Count; i++)
            {
        ...
        /// </summary>
        /// <param name="cellView"></param>
        private void _RecycleCell(ScrollViewItem cellView)
        {
        ...
        void Awake()
        {
            ...
            if(_scrollRect == null) _scrollRect = this.GetComponentInChildren<ScrollRect>();
