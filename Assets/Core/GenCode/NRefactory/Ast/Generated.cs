...
namespace BridgeUI.NRefactory.Ast {
	...
	public class AttributeSection : AbstractNode {
		...
		List<BridgeUI.NRefactory.Ast.Attribute> attributes;
		...
		public List<BridgeUI.NRefactory.Ast.Attribute> Attributes {
			get {
				return attributes;
			}
			set {
		...
		public AttributeSection(string attributeTarget, List<BridgeUI.NRefactory.Ast.Attribute> attributes) {
