...
namespace BridgeUI.NRefactory.Parser
{
	/// <summary>
	...
	public abstract class AbstractLexer : ILexer
	{
		...
		/// <summary>
		/// The current Token. <seealso cref="BridgeUI.NRefactory.Parser.Token"/>
		/// </summary>
		public Token Token {
			get {
//				Console.WriteLine("Call to Token");
		...
		/// <summary>
		/// The next Token (The <see cref="Token"/> after <see cref="NextToken"/> call) . <seealso cref="BridgeUI.NRefactory.Parser.Token"/>
		/// </summary>
...
//			Console.WriteLine("Call to Peek");
		...
		public virtual Token NextToken()
		{
			if (curToken == null) {
				...
				//Console.WriteLine(BridgeUI.NRefactory.Parser.CSharp.Tokens.GetTokenString(curToken.kind) + " -- " + curToken.val + "(" + curToken.kind + ")");
				return curToken;
			}
