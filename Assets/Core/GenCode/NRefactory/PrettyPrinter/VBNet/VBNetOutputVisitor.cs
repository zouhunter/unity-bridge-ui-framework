...
using BridgeUI.NRefactory.Parser.VB;

namespace BridgeUI.NRefactory.PrettyPrinter
{
	public class VBNetOutputVisitor : IOutputAstVisitor
	{
		...
		#region BridgeUI.NRefactory.Parser.IASTVisitor interface implementation
		...
		public object VisitAttribute(BridgeUI.NRefactory.Ast.Attribute attribute, object data)
		{
