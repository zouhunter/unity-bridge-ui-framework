...
namespace BridgeUI.NRefactory.Visitors {
	...
	public abstract class AbstractAstTransformer : IAstVisitor {
		...
		public virtual object VisitAttribute(BridgeUI.NRefactory.Ast.Attribute attribute, object data) {
		...
		public virtual object VisitAttributeSection(AttributeSection attributeSection, object data) {
			...
			for (int i = 0; i < attributeSection.Attributes.Count; i++) {
				BridgeUI.NRefactory.Ast.Attribute o = attributeSection.Attributes[i];
				Debug.Assert(o != null);
				nodeStack.Push(o);
				o.AcceptVisitor(this, data);
				o = (BridgeUI.NRefactory.Ast.Attribute)nodeStack.Pop();
				if (o == null)
