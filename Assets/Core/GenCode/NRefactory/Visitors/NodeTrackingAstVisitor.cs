...
namespace BridgeUI.NRefactory.Visitors {
	...
	public abstract class NodeTrackingAstVisitor : AbstractAstVisitor {
		...
		public sealed override object VisitAttribute(BridgeUI.NRefactory.Ast.Attribute attribute, object data) {
		...
		public virtual object TrackedVisit(BridgeUI.NRefactory.Ast.Attribute attribute, object data) {
