...
public class customEventViewModel : ViewModel
{
    ...
    public BridgeUI.Binding.PanelAction<System.String,System.Int32> on_event_execute {
		get {
			return GetValue<BridgeUI.Binding.PanelAction<System.String,System.Int32>> (keyword_on_event_execute);
		}
		set {
			SetValue<BridgeUI.Binding.PanelAction<System.String,System.Int32>> (keyword_on_event_execute, value);
		}
	}
    #endregion
