...
///[代码说明信息]
///<summary>
public abstract class UserControlPanel_ViewModel : BridgeUI.Binding.ViewModelObject
{
	#region 属性列表
	...
	#endregion 属性列表
	protected const string keyword_infos = "infos";

	protected const string keyword_onSelect = "onSelect";
}
