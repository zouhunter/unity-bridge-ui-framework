...
namespace ListView
{
    ...
    {
        protected sealed class ListViewItemTemplate
        {
        ...
        protected virtual void Start()
        {
            ...
            foreach (var template in m_Templates)
            {
                ...
                m_TemplateDictionary[templateName] = new ListViewItemTemplate(template);
            }
        }
        ...
        protected virtual bool GetNewItem(TData datum, out TItem item)
        {
            ...
            {
                item = Instantiate(template.prefab, transform, false).GetComponent<TItem>();
