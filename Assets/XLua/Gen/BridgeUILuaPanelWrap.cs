...
namespace XLua.CSObjectWrap
{
    ...
    public class BridgeUILuaPanelWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(BridgeUI.LuaPanel);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					BridgeUI.LuaPanel __cl_gen_ret = new BridgeUI.LuaPanel();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to BridgeUI.LuaPanel constructor!");
        ...
        static int _g_get_luaScript(RealStatePtr L)
        {
		    try {
                ...
                BridgeUI.LuaPanel __cl_gen_to_be_invoked = (BridgeUI.LuaPanel)translator.FastGetCSObj(L, 1);
