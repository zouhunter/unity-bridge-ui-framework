...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineRendererWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 3, 22, 17);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "useLightProbes", _g_get_useLightProbes);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "useLightProbes", _s_set_useLightProbes);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_useLightProbes(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_useLightProbes(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
