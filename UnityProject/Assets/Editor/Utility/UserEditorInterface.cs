...
{
    public class UserEditorInterface
    {
        ...
        public void DrawToolbarGUI(Rect rect)
        {
            ...
            if (GUILayout.Button("Build Prefab", NodeEditorGUI.toolbarButton, GUILayout.Width(100)))
            {
                var rootNode = canvasCache.nodeCanvas.nodes;
